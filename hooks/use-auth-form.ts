...
import { validate } from "@/lib/auth/schemas"
...
// Shared submit + error-merging logic for the auth forms. Reads the form via
...
export function useAuthForm<TSchema extends v.GenericSchema>(
  schema: TSchema,
